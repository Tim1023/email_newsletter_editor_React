	...
	return (
		...
		>
			...
			onClick={() => {
				...
				if (!templateName) {
					return alert('Please type template name in COMMON tab');
				}
				let outCss = `<link rel="stylesheet" href="/Users/timzhao/Documents/GitHub/react_email_editor/public/tinymce/skins/lightgray/content.inline.min.css" type="text/css" />`
				emailSource = outCss.concat(emailSource);
